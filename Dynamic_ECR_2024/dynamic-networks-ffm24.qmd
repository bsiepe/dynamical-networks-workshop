...
::: notes
-   useful to think of the hype cycle 
-   networks in general: already passed disilusionment
:::
...
::: column
::: fragment
![](figures/regression_meme.jpg){fig-align="right" height="500" width="600"}
::: 
:::
::::

::: notes
- not extremely important for everyone, but still good to know
:::
...
-   Also many other forms, mixture modeling, etc.
:::
...
![](figures/gimme_viz.png){fig-align="center" height="600" width="700"}

::: aside
Taken from [GIMME homepage](https://tarheels.live/gimme/subgrouping-gimme/)
:::


## Interpretation: Time Intervals

-   Equal time intervals between measurements. Problem?
    -   Night effect [@berkhoutLetSleepingDogs2024] ![](figures/night_effect_viz.png){fig-align="center" height="500" width="550"}

::: notes
-   What about night effect?
-   Removing night effect also decreases sample size!
:::
...
::: notes
-   Removing the trend means removing information
-   Often only remove part of nonstationarity
:::
...
knitr::include_graphics(here::here('Dynamic_ECR_2024/figures/detrending_viz.svg'))
```
:::
...
::: fragment
-   Causality
-   Measurement [@bringmannPsychopathologicalNetworksTheory2022]
-   Variable selection
-   Sparsity
-   Missing data
...
knitr::include_graphics(here::here('Dynamic_ECR_2024/figures/viz_floor.svg'))
```
:::
::: fragment
```{r, echo = FALSE, out.height=250, out.width=300}
knitr::include_graphics(here::here('Dynamic_ECR_2024/figures/viz_mode.svg'))
```
:::
::::
:::::::
...
::: notes
assumptions are not just nuisance
:::
...
::: fragment
![](figures/plot_ranef.png)
:::

# Evidence and Pitfalls {background-color="#40666e"}
...
-   Number of variables?
    ...
    -   idiographic gVAR:
        ...
        - 4 variables: $16 + 6 = 22$ parameters
...
-   Tests to compare idiographic networks
    ...
    -   @hoekstraTestingSimilarityLongitudinal2024: R package `INIT` based on SEM
    -   Siepe, Kloft & Heck [-@siepeBayesianEstimationComparison2024]: R package `tsnet` based on Bayesian estimation
...
:::: column
::: fragment
![](figures/connectivity_networks.png){width="550" height="550" fig-align="left"}
:::
::::
...
```{r, out.width = '1000px', out.height= "650px", echo = FALSE}
knitr::include_graphics(here::here('Dynamic_ECR_2024/figures/postcent.svg'))
```

::: aside
{{< fa brands r-project >}} `tsnet`: Siepe et al. [-@siepeBayesianEstimationComparison2024]
:::
...
::: notes
-   expert teams, given experience sampling data, find treatment target
-   mostly VAR
:::
...
::: fragment
![](figures/multiverse_screen.png){width="650" height="550" fig-align="center"}
:::

::: aside
Siepe & Heck [-@siepeMultiverseAnalysisDynamic2023]
:::
...
:::: {.column width="70%"}
::: fragment
> What is the VAR-based network representing, and what hypotheses are we testing with it? [...] can be more explicit about which connections in the network are to be expected and which are contrary to previous knowledge [@bringmannPersonspecificNetworksPsychopathology2021]
:::
::::

:::: {.column width="30%"}
::: fragment
![](figures/treadmill-gif.gif){width="280" height="280" fig-align="right"}
:::
::::
:::::::
...
::: notes
-  it would be a shame if we do 10 more years of low-powered exploratory VAR modeling
...
::: notes
- asked by Laura Bringmann 2016 
- still no good answers
- made difficult by the ambiguity of what "dynamic network" means
:::
...
{{< fa brands bluesky >}} [:)](https://bsky.app/profile/bsiepe.bsky.social)
...
Treadmill GIF from [tenor](https://tenor.com/de/view/fitness-workout-silly-treadmill-gif-8663454)

Regression Meme created with [ImgFlip](https://imgflip.com/memegenerator/)

...
- Kanten: gewichtet/ungewichtet und direktional/undirektional sein
  - gewichtet/ungewichtet
  - direktional/undirektional
- In der Psychologie: erste Arbeiten ~2010

## Beispielnetzwerk
- Bridge Network aus Literatur
...
knitr::include_graphics('example-net.png')
```
...
- graphicalVAR Formel
$$Anhedonie_{t} = a*Anhedonie_{t-1} + b*Hoffnungslosigkeit_{t-1} + \epsilon $$
$$
...
- aber Annahme: gleiche Verteilung, nicht ganz idiographisch
- GIMME
- DSEM
...
## Interpretation
- Zeitabstände zwischen Messungen (continuous time etc.)
- Kausalität?
- Stationarität
- Stabilität idiographischer Netzwerkschätzungen

- simplifizierendes Abbild eines komplexen Systems

## Evidenz bei Einsatz in klinischer Praxis
- Frumkin et al. (2021): Fallstudien, Patient\*innen überzeugter als Therapeut\*innen
- Levinson et al. (2023):
- Hall et al. (2023): Fallstudie
- Keine eindeutige Evidenz (RCT?)
...
![](pecan.jpeg)
https://doi.org/10.1177/10731911211039281
...
TODO: QR Code für Materialien


::: {.notes}
https://mine-cetinkaya-rundel.github.io/quarto-tip-a-day/posts/18-font-awesome/
:::

...
knitr::include_graphics('network-centrality2.jpg')
```
...
knitr::include_graphics('hype_cycle.svg')
```
...
## Zeitreihendaten
```{r, out.width = '900px', out.height= "500px"}
knitr::include_graphics('data-cube.jpg')
```
...
knitr::include_graphics('smartwatch-unsplash.jpg')
```
::: 

::: {.column}
```{r, out.width = '500px', out.height= "400px"}
knitr::include_graphics('smartphone-unsplash.jpg')
```
:::
...
knitr::include_graphics('mlVAR-example.jpeg')
```

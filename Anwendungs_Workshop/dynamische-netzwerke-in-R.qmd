...
::: fragment
Alternativ hilfreich: Histogramm für alle Variablen einer Person:
```{r}
...
<!-- ![](Anwendungs_Workshop/figures/premise.png) -->
...
2.  RMSSD von allen Variablen im Datensatz berechnen.
3.  Gruppencutoff für GIMME ändern
